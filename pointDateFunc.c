/*		**********
	exercise 11 chapter 11 Programming in C
		This Tomorrow Does Know...w/pointers
		   *****	*/
#include <stdio.h>
#include <stdbool.h>
...
int main (void)
{
	...
	struct date today, *tomorrow, *datePtr;
